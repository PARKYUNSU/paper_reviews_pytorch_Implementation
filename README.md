...
#### RNN 표현 방식
아래 그림은 RNN의 두 가지 표현 방식을 보여줍니다:

<img src="https://github.com/user-attachments/assets/0da3970a-20e3-4f32-96e6-a73f07a0dfb9" width=500 alt="RNN 표현방식">

1. **재귀적 표현 (좌측)**: 시간적 흐름을 화살표로 나타냅니다.  
2. **펼친 표현 (우측)**: 시간 축에 따라 여러 time step을 나열하여 시간적 관계를 명확히 드러냅니다.
