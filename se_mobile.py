...
class SE_MobileNetV1(nn.Module):
    def __init__(self, alpha, num_classes=10, init_weight=True):
        super(SE_MobileNetV1).__init__()
        ...
        self.model = nn.Sequential(
            ...
            *[DwSepConv(int(512 * self.alpha), int(512 * self.alpha)) for _ in range(5)],
